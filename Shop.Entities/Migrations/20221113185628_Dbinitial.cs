    ...
    public partial class Dbinitial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { "abc", 1L, "admin", 1, "a", new DateTime(2022, 11, 14, 1, 56, 27, 343, DateTimeKind.Local).AddTicks(1253), new DateTime(2022, 11, 14, 1, 56, 27, 341, DateTimeKind.Local).AddTicks(6770), true, false, "Dương", "1", "123", 1, true });

            migrationBuilder.InsertData(
                table: "Accounts",
                columns: new[] { "Email", "ID", "Username", "AccountType", "Address", "BirthDay", "CreatedDate", "IsActive", "IsDelete", "Name", "Password", "Phone", "Sex", "Status" },
                values: new object[] { "zxxz", 2L, "user", 2, "a", new DateTime(2022, 11, 14, 1, 56, 27, 343, DateTimeKind.Local).AddTicks(4489), new DateTime(2022, 11, 14, 1, 56, 27, 343, DateTimeKind.Local).AddTicks(4481), true, false, "Dương", "1", "123", 2, true });
