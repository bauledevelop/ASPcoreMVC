    ...
    public partial class DBInitial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { "abc", 1L, "admin", 1, "a", new DateTime(2022, 12, 15, 0, 14, 57, 667, DateTimeKind.Local).AddTicks(2692), new DateTime(2022, 12, 15, 0, 14, 57, 667, DateTimeKind.Local).AddTicks(2681), true, false, "Dương", "1", "123", 1, true });

            migrationBuilder.InsertData(
                table: "Accounts",
                columns: new[] { "Email", "ID", "Username", "AccountType", "Address", "BirthDay", "CreatedDate", "IsActive", "IsDelete", "Name", "Password", "Phone", "Sex", "Status" },
                values: new object[] { "zxxz", 2L, "user", 2, "a", new DateTime(2022, 12, 15, 0, 14, 57, 667, DateTimeKind.Local).AddTicks(2698), new DateTime(2022, 12, 15, 0, 14, 57, 667, DateTimeKind.Local).AddTicks(2697), true, false, "Dương", "1", "123", 2, true });
