    ...
    public partial class Dbinitial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1L, 1, "a", new DateTime(2022, 11, 12, 22, 50, 17, 467, DateTimeKind.Local).AddTicks(6104), new DateTime(2022, 11, 12, 22, 50, 17, 464, DateTimeKind.Local).AddTicks(3453), "abc", true, false, "Dương", "1", "123", 1, true, "admin" });

            migrationBuilder.InsertData(
                table: "Accounts",
                columns: new[] { "ID", "AccountType", "Address", "BirthDay", "CreatedDate", "Email", "IsActive", "IsDelete", "Name", "Password", "Phone", "Sex", "Status", "Username" },
                values: new object[] { 2L, 2, "a", new DateTime(2022, 11, 12, 22, 50, 17, 468, DateTimeKind.Local).AddTicks(4613), new DateTime(2022, 11, 12, 22, 50, 17, 468, DateTimeKind.Local).AddTicks(4569), "zxxz", true, false, "Dương", "1", "123", 2, true, "user" });
